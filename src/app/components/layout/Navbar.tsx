    ...
    <>
      ...
      <div className="hidden lg:block bg-[#0F5132] dark:bg-gray-900 text-white transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="relative flex items-center justify-center h-12">
            <div className="flex items-center gap-6 xl:gap-8 h-full">
              ...
              <div className="relative group h-full flex items-center">
                ...
                <div className="absolute top-12 left-0 w-64 bg-[#0F5132] dark:bg-gray-900 border border-white/10 dark:border-gray-800 rounded-xl shadow-xl py-3 z-50 opacity-0 -translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-300">
                  ...
                  <Link to="/estudiantes/egresados" className="block px-4 py-2.5 text-xs font-medium hover:bg-[#D4A574] hover:text-[#0F5132] transition-colors text-white">
                    Egresados
                  </Link>
                  ...
                  <Link to="/estudiantes/sigo" className="block px-4 py-2.5 text-xs font-medium hover:bg-[#D4A574] hover:text-[#0F5132] transition-colors text-white">
                    SIGO
                  </Link>
                </div>
              </div>
            ...
            <div>
              ...
              {mobileMenus.estudiantes && (
                <div className="pl-4 py-2 flex flex-col gap-2 bg-gray-50 dark:bg-gray-900/40 rounded-xl mt-1">
                  ...
                  <Link to="/estudiantes/egresados" onClick={() => setIsMenuOpen(false)} className="text-xs py-1.5 text-gray-600 dark:text-gray-400 hover:text-[#0F5132] dark:hover:text-[#D4A574]">
                    Egresados
                  </Link>
                  ...
                  <Link to="/estudiantes/sigo" onClick={() => setIsMenuOpen(false)} className="text-xs py-1.5 text-gray-600 dark:text-gray-400 hover:text-[#0F5132] dark:hover:text-[#D4A574]">
                    SIGO
                  </Link>
                </div>
              )}
